...
plt.figure()
plt.scatter(gbyYMZ.index, gbyYMZ.values,c="yellow",s=gbyYMZ.values/2000)
plt.scatter(gbyGMZ.index,gbyGMZ.values,c="green",s=gbyYMZ.values/2000)
...
#%%Scatter plot of number of taxi rides in each start borough in may
plt.figure()
plt.scatter(gbyYYZ.index, gbyYYZ.values,c="yellow",s=gbyYYZ.values/2000)
plt.scatter(gbyGYZ.index,gbyGYZ.values,c="green",s=gbyGYZ.values/2000)
...
print(cashGreenJuly["VendorID"].count()/greenMayZones2019["VendorID"].count())
